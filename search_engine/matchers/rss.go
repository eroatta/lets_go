...
type (
    ...
    item struct {
        ...
        GeoRssPoing string `xml:"georss:point"`
    }
...
// looks at the document for the specified search term
...
// performs an HTTP GET request for the RSS feed and decodes the results
func (m rssMatcher) retrieve(feed *search.Feed) (*rssDocument, error) {
    ...
    // decode the rss document into our struct type
